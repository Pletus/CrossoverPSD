...
//         <div className=' flex flex-row mt-10 justify-center gap-20'>
//           <div className=''>
//             <div className=' border bg-rose-700 mx-auto w-96'>
//               <img className='' src={cakepng} alt='' />
//               <div className='p-3 '>
//                 <h5 className='mb-2 text-2xl text-center font-bold tracking-tight text-white'>
//                   sweet berry pie
//                 </h5>

//                 <p className='mb-3 font-normal text-center text-slate-200'>
//                   the sweetest and easiest <br /> berry pie perfect for the{" "}
//                   <br />
//                   Holidays!
//                 </p>
...
//         <div>
//           <button className=' px-3 py-1 text-sm font-medium text-center  text-rose-700 bg-white border-4 border-red-800 rounded-lg '>
//             Read more
//           </button>
//         </div>
